        ...
        <div>
            ...
            <div className="modal modal-bottom sm:modal-middle z-50">
                <div className="modal-box z-50 relative text-center py-10">
                    <label for="edit-confirm-modal" className="p-2 text-secondary cursor-pointer absolute right-2 top-2">
                    ...
                    <div className="flex justify-center gap-5">
                        <label for="edit-confirm-modal" className="btn btn-primary  px-10">
                            Ok
                        </label>
                    </div>
                </div>
