        ...
        <div>
            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box p-10 relative">
                    <label for="profile-modal" className="btn btn-sm btn-circle absolute right-2 top-2">
                        ✕
                    </label>
                    ...
                    <form className="" onSubmit={handleSubmit(handleEditProfile)}>
                        ...
                        <div className="form-control">
                            <button type="submit">
                                <label className={`w-full btn ${loading && "loading"} btn-primary`} for="profile-modal">
                                    Save
                                </label>
                            </button>
                        </div>
